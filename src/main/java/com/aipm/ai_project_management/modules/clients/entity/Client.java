...
public class Client extends AuditableEntity {
    ...
    // Relationships - Now using Set instead of List
    ...
    @OneToMany(mappedBy = "client", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    private Set<ClientCustomField> customFields = new HashSet<>();
    ...
    public Set<ClientCustomField> getCustomFields() {
        return customFields;
    }

    public void setCustomFields(Set<ClientCustomField> customFields) {
